...
function usa_detectCurrentDevice() {
  ...
  var iOS =
    ...
    agent.toLowerCase().indexOf("ipad") != -1
      ? true
      : false;
  ...
  var android =
    ...
    (!iOS && !otherBrowser && touchOS && mobileOS)
      ? true
      : false;
  var smartphone = false;
  var mobileDevice =
    iOS || android || mobileOS || touchOS || otherBrowser ? true : false;
...
if (
  s_domain.indexOf("dev") != -1 ||
  s_domain.indexOf("beta") != -1 ||
  s_domain.indexOf("test") != -1 ||
  s_domain.indexOf("stage") != -1 ||
...
s.linkInternalFilters =
  "javascript:,usanetwork.com,characterbrandworks.com,charactersunite.com,characterblog.com,suitsoncampus.com,westminsterkennelclub.org,htk2.theatrics.com,samsung.com,twitter.com/intent,whoismrrobot";
...
function s_doPlugins(s) {
  ...
  if (s.oun.match("nbcucabled") || s.oun.match("nbcuusanetbu")) {
    s.sa("nbcuglobal,nbcuusanetworkd");
  }

  //disable auto download link tracking on characterbrandworks.com,
  if (document.URL.match("characterbrandworks.com")) {
    s.trackDownloadLinks = false;
  }

  //bunchball genesis code
  if (typeof bunchball_nitro_id != "undefined") {
    s.visitorID = bunchball_nitro_id;
  }
  ...
  //Props
  if (typeof usa_clubOmnitureProp1 != "undefined") {
    s.prop1 = usa_clubOmnitureProp1;
  }
  ...
  if (s.prop6.match("iframe")) {
    s.prop32 = "New Site";
  } // iframed content that shows within responsive design
  ...
  //Hierarchies
  if (typeof s.prop2 == "undefined" || s.prop2 == "") {
    sprop2 = "miscellaneous";
  } else {
    sprop2 = s.prop2;
  }
  if (typeof s.prop3 == "undefined" || s.prop3 == "") {
    sprop3 = "miscellaneous";
  } else {
    sprop3 = s.prop3;
  }
  if (typeof s.prop4 == "undefined" || s.prop4 == "") {
    sprop4 = "miscellaneous";
  } else {
    sprop4 = s.prop4;
  }
  if (typeof s.prop10 == "undefined" || s.prop10 == "") {
    sprop10 = "miscellaneous";
  } else {
    sprop10 = s.prop10;
  }
  ...
  if (typeof s != "undefined") {
    ...
    if (typeof document.documentElement.clientWidth != "undefined") {
      ...
      if (usa_cw <= 644) {
        s.eVar68 = usa_deviceInfo.mobileDevice
          ? "Smartphone Portrait"
          : "Desktop";
